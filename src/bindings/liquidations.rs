...
mod liquidations_mod {
    ...
    #[derive(Clone)]
    pub struct Liquidations<M>(Contract<M>);
    impl<M> std::ops::Deref for Liquidations<M> {
        type Target = Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M: Middleware> std::fmt::Debug for Liquidations<M> {
    ...
    impl<'a, M: Middleware> Liquidations<M> {
        #[doc = r" Creates a new contract instance with the specified `ethers`"]
        #[doc = r" client at the given `Address`. The contract derefs to a `ethers::Contract`"]
        #[doc = r" object"]
        pub fn new<T: Into<Address>>(address: T, client: Arc<M>) -> Self {
            let contract = Contract::new(address.into(), LIQUIDATIONS_ABI.clone(), client);
            Self(contract)
        }
        #[doc = "Calls the contract's `price` (0xaea91078) function"]
        pub fn price(&self, user: Address) -> ContractCall<M, U256> {
            self.0
        ...
        #[doc = "Calls the contract's `liquidate` (0x2f865568) function"]
        pub fn liquidate(&self, user: Address) -> ContractCall<M, ()> {
            self.0
                .method_hash([47, 134, 85, 104], user)
                .expect("method not found (this should never happen)")
        }
        #[doc = "Calls the contract's `totals` (0xc038a38e) function"]
        pub fn totals(&self) -> ContractCall<M, (u128, u128)> {
            self.0
                .method_hash([192, 56, 163, 142], ())
                .expect("method not found (this should never happen)")
        }
        #[doc = "Calls the contract's `erase` (0xe85b0080) function"]
        pub fn erase(&self, user: Address) -> ContractCall<M, (u128, u128)> {
            self.0
        ...
        pub fn liquidations(&self, p0: Address) -> ContractCall<M, U256> {
            self.0
        ...
        pub fn liquidation_filter(&self) -> Event<M, LiquidationFilter> {
            self.0
                .event("Liquidation")
                .expect("event not found (this should never happen)")
        }
