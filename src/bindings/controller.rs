...
mod controller_mod {
    ...
    #[derive(Clone)]
    pub struct Controller<M>(Contract<M>);
    ...
    impl<M: Middleware> std::fmt::Debug for Controller<M> {
    ...
    impl<'a, M: Middleware> Controller<M> {
        ...
        pub fn weth(&self) -> ContractCall<M, [u8; 32]> {
            self.0
                .method_hash([173, 92, 70, 72], ())
                .expect("method not found (this should never happen)")
        }
        #[doc = "Calls the contract's `debtYDai` (0x98cdae5a) function"]
        pub fn debt_y_dai(&self, p0: [u8; 32], p1: U256, p2: Address) -> ContractCall<M, U256> {
            self.0
                .method_hash([152, 205, 174, 90], (p0, p1, p2))
                .expect("method not found (this should never happen)")
        }
        #[doc = "Calls the contract's `seriesIterator` (0xdd102225) function"]
        pub fn series_iterator(&self, p0: U256) -> ContractCall<M, U256> {
            self.0
        ...
        pub fn power_of(&self, collateral: [u8; 32], user: Address) -> ContractCall<M, U256> {
            self.0
                .method_hash([192, 99, 49, 220], (collateral, user))
                .expect("method not found (this should never happen)")
        }
        #[doc = "Calls the contract's `revokeDelegate` (0xfa352c00) function"]
        pub fn revoke_delegate(&self, delegate: Address) -> ContractCall<M, ()> {
            self.0
        ...
        pub fn add_delegate(&self, delegate: Address) -> ContractCall<M, ()> {
            self.0
                .method_hash([231, 27, 223, 65], delegate)
                .expect("method not found (this should never happen)")
        }
        #[doc = "Calls the contract's `totalDebtDai` (0xe68b7cf4) function"]
        pub fn total_debt_dai(&self, collateral: [u8; 32], user: Address) -> ContractCall<M, U256> {
            self.0
        ...
        pub fn posted_filter(&self) -> Event<M, PostedFilter> {
            self.0
                .event("Posted")
                .expect("event not found (this should never happen)")
        }
        #[doc = "Gets the contract's `Delegate` event"]
        pub fn delegate_filter(&self) -> Event<M, DelegateFilter> {
            self.0
                .event("Delegate")
                .expect("event not found (this should never happen)")
        }
        ...
        pub fn borrowed_filter(&self) -> Event<M, BorrowedFilter> {
            self.0
                .event("Borrowed")
                .expect("event not found (this should never happen)")
        }
        #[doc = "Gets the contract's `GrantedAccess` event"]
        pub fn granted_access_filter(&self) -> Event<M, GrantedAccessFilter> {
            self.0
                .event("GrantedAccess")
                .expect("event not found (this should never happen)")
        }
